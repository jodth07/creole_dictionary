...
translation_en_ht = pipeline('translation',
                                model=model,
                                tokenizer=tokenizer,
                                src_lang=lang_en,
                                tgt_lang=lang_ht,
...
translation_ht_en = pipeline('translation',
                                model=model,
                                tokenizer=tokenizer,
                                src_lang=lang_ht,
                                tgt_lang=lang_en,
...
def word_def_dictionary(dictionary_list: Optional[list] = None):
    ...
    return {dictionary["word"]: dictionary["definition"] for dictionary in dictionary_list}
